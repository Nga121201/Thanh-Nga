            ...
            <div class="container">
                <div class="breadcrumb_text text-left">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="vaccine_chi_tiet.php"></a>VACCINE </li>
                    </ul>
                </div>
            </div>
        </section>
          ...
          <?php 
                   ...
                   $vaccine_id = $_GET["id"];
                    ...
                    $sql = " SELECT * 
                            ...
                            where tbl_vaccine.vaccine_id= tbl_vaccine_chi_tiet.vaccine_id and tbl_vaccine.vaccine_id=".$vaccine_id." ORDER BY  tbl_vaccine.vaccine_id DESC";
