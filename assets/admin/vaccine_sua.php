                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            //4.
                            $row = mysqli_fetch_array($noi_dung_vaccine);
                                       
                            ;?>
                                <form method="POST" action="vaccine_sua_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTen" name="txtTen" placeholder="Tên VACCINE" value="<?php echo $row['ten_vaccine'];?>" />
                                    ...
                                    <div class="form-floating mb-3">
                                         <textarea class="form-control" id="txtMoTa" name="txtMoTa" placeholder="Mô tả"><?php echo $row['mo_ta'];?></textarea>
                                            <label for="txtChucVu">Chức Vụ</label>
                                    </div>
                                    <div class="mt-4 mb-0">
                                    <input type="hidden" name="txtID" value="<?php echo $row['vaccine_id'];?>">
