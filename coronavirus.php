      ...
      <div class="container">
        <div class="breadcrumb_text">
          ...
          <ul class="nav justify-content-center wow fadeInUp" data-wow-delay="0.3s">
            ...
            <li><a href="coronavirus.php">Thông tin về COVID-19</a></li>
          </ul>
        </div>
      </div>
    </section>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-6 wow fadeIn" data-wow-delay="400ms">
            <div class="about_features_item">
              ...
              <a class="text_btn" href="single-blog.php?id=1">Đọc thêm <i class="linearicons-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 wow fadeIn" data-wow-delay="500ms">
            <div class="about_features_item">
              ...
              <a class="text_btn" href="single-blog.php?id=2">Đọc thêm <i class="linearicons-arrow-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 wow fadeIn" data-wow-delay="600ms">
            <div class="about_features_item">
              ...
              <a class="text_btn" href="single-blog.php?id=3">Đọc thêm <i class="linearicons-arrow-right"></i></a>
            </div>
          </div>
        </div>
      </div>
